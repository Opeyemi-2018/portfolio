        ...
        <div className="max-w-6xl mx-auto sm:pt-28 pt-10 pb-2  flex lg:flex-row flex-col   justify-between">
          <div data-aos="fade-down" className="flex flex-col gap-2 flex-1">
            ...
            >
              ...
              Express.js, React.js, and Node.js.), as well as Next.js,
              Typescript, and Nest.js. I specialize in building full-stack web
              applications, developing robust server-side APIs, and creating
              dynamic, responsive frontend interfaces.{" "}
            </p>
